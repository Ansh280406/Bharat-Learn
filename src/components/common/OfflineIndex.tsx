...
import {
  Heart, Droplets, Hash, Sword, ArrowRight, Sparkles, BookOpen, Sun,
    ...
    subjects: [
      {
        ...
        modules: [
          {
            type: 'physics', chapter: 'Chapter 9', title: 'Ray Optics & Optical Instruments',
      ...
      },
      {
        ...
        modules: [
          {
            type: 'chemistry', chapter: 'Chapter 12', title: 'Aldehydes, Ketones & Carboxylic Acids',
      ...
      },
      {
        ...
        modules: [
          {
            type: 'math_3d', chapter: 'Chapter 11', title: '3D Geometry',
  ...
  },
  {
    ...
    subjects: [
      ...
      },
      {
        ...
        modules: [
          {
            type: 'chemistry', chapter: 'Chapter 4', title: 'Chemical Bonding & Molecular Structure',
      ...
      },
      {
        ...
        modules: [
          {
            type: 'history', chapter: 'Chapter 4', title: 'Battle of Panipat (1526)',
    ...
    subjects: [
      {
        ...
        modules: [
          {
            type: 'heart', chapter: 'Chapter 6', title: 'Life Processes — Human Heart',
      ...
      },
      {
        ...
        modules: [
          {
            type: 'math', chapter: 'Chapter 4', title: 'Quadratic Equations',
      ...
      },
      {
        ...
        modules: [
          {
            type: 'water_cycle', chapter: 'Chapter 3', title: 'Water Resources',
      ...
      },
      {
        ...
        modules: [
          {
            type: 'chemistry', chapter: 'Chapter 1', title: 'Chemical Reactions & Equations',
    ...
    subjects: [
      {
        ...
        modules: [
          {
            type: 'water_cycle', chapter: 'Chapter 5', title: 'Natural Vegetation & Water',
            ...
            emoji: '🌧️', tags: ['NCERT', 'Water Cycle', 'Environment'],
            difficulty: 'Beginner', duration: '7 min', ncertRef: 'Class VIII Geography, Ch. 5',
          },
        ],
      },
      {
        ...
        modules: [
          {
            type: 'math', chapter: 'Chapter 4', title: 'Linear Equations in Two Variables',
          ...
          {activeSubject.modules.map((mod) => {
            ...
            return (
              <div
                ...
                className="glass-card anim-fade-up"
                onClick={() => onSelectSubject(mod.type)}
